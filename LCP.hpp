...
// Un iterador es una función que cuando se llama repetidamente devuelve cada elemento de la lista
template <class Gn>
...
// Función accesoria que exhibe los elementos del objeto CsPilas. Tiene como argumento un objeto de
// tipo CsPilas. Esta función usa la funcion IteradorFaGn
...
// Función asociada a CsPilas, exhibe los elementos del objeto CsPilas. No tiene argumentos. Esta función
